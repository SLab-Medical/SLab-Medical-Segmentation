...
class Generic_UNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels=1, base_num_features=32, num_classes=14, num_pool=5, num_conv_per_stage=2,
    ...
    def forward(self, x, mode='test'):
        ...
        for u in range(len(self.tu)):
            ...
            seg_outputs.append(self.seg_outputs[u](x)) #self.final_nonlin()
